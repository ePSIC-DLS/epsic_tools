...
print("Tim Poon's beta version for MIB conversion.")
import h5py
import shutil
...
class convert_info_widget():
    ...
    def _organize(self, no_reshaping, use_fly_back, known_shape, 
        ...
        self.python_script_path = '/dls_sw/e02/software/MIB_convert_widget_beta/scripts/MIB_convert_submit.py'
        if create_batch_check:
            ...
            print(f"script path is {self.python_script_path}")
            with open (self.bash_script_path, 'w') as f:
                ...
                f.write('sleep 10\n')
                f.write(f"srun -c ${{SLURM_CPUS_PER_TASK}} >")
