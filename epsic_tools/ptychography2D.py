...
class Ptychography2D(object):
    ...
    #load a ptyrex reconstruction
        ...
        params, d, p, e = ptyrex.load_recon(fn)
        self.recon_object = d
        self.recon_probe = p
        #self.recon_object_fft = d_s_fft
        #self.recon_radial_object_fft = rad_fft
    ...
    def get_detector_orientation(self):
        #print(self.params['process']['common']['detector']['orientation'])
        return self.params['process']['common']['detector']['orientation']
        
    def set_detector_orientation(self, val):
        if len(val) == 2:
            self.params['process']['common']['detector']['orientation'] = val
        else:
